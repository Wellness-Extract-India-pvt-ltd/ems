...
// Mock the biometrics connection functions
const mockBiometricsConnection = {
  executeBiometricsQuery: vi.fn(),
  testBiometricsConnection: vi.fn(),
  getBiometricsDatabaseInfo: vi.fn()
}

// Mock the BiometricEmployee model
const mockBiometricEmployee = {
  findOne: vi.fn(),
  create: vi.fn(),
  update: vi.fn()
}

describe('BioMetrics Controller Tests', () => {
  let controllerPath
  let fileContent
  ...
  beforeAll(async () => {
    ...
    vi.mock('../database/biometricsConnection.js', () => (mockBiometricsConnection))
    vi.mock('../models/BiometricEmployee.js', () => ({ default: mockBiometricEmployee }))
  ...
  describe('testConnection Function', () => {
    it('should have testConnection function with proper signature', () => {
    ...
    it('should handle connection errors', () => {
      ...
      expect(fileContent).toContain('res.status(500).json({')
      expect(fileContent).toContain('message: \'BioMetrics database connection error\'')
    })
  ...
  describe('getDatabaseInfo Function', () => {
    it('should have getDatabaseInfo function with proper signature', () => {
    ...
    it('should handle database info errors', () => {
      ...
      expect(fileContent).toContain('res.status(500).json({')
      expect(fileContent).toContain('message: \'Failed to get database information\'')
    })
  })

  describe('getBiometricEmployees Function', () => {
    it('should have getBiometricEmployees function with proper signature', () => {
    ...
    it('should handle search filtering', () => {
      ...
      expect(fileContent).toContain('params.search = `%${search}%`')
    })
    ...
    it('should handle department filtering', () => {
      ...
      expect(fileContent).toContain('params.department = department')
    })
    ...
    it('should handle status filtering', () => {
      ...
      expect(fileContent).toContain('params.status = status')
    })

    it('should add pagination', () => {
      expect(fileContent).toContain('ORDER BY Emp_Name OFFSET @offset ROWS FETCH NEXT @limit ROWS ONLY')
      expect(fileContent).toContain('params.offset = (parseInt(page) - 1) * parseInt(limit)')
      expect(fileContent).toContain('params.limit = parseInt(limit)')
    })
    ...
    it('should handle employee fetch errors', () => {
      ...
      expect(fileContent).toContain('res.status(500).json({')
      expect(fileContent).toContain('message: \'Failed to fetch employees\'')
    })

    it('should have inline comments', () => {
      expect(fileContent).toContain('// Extract query parameters with defaults')
      expect(fileContent).toContain('// Build SQL query based on POC findings for employee data')
      expect(fileContent).toContain('// Add search filter for employee name or code')
      expect(fileContent).toContain('// Add department filter')
      expect(fileContent).toContain('// Add status filter')
      expect(fileContent).toContain('// Add pagination with OFFSET and FETCH')
      expect(fileContent).toContain('// Execute the main query')
    })
  })

  describe('getEmployeeAttendance Function', () => {
    it('should have getEmployeeAttendance function with proper signature', () => {
    ...
    it('should handle attendance fetch errors', () => {
      ...
      expect(fileContent).toContain('res.status(500).json({')
      expect(fileContent).toContain('message: \'Failed to fetch attendance records\'')
    })
  })

  describe('getAttendanceSummary Function', () => {
    it('should have getAttendanceSummary function with proper signature', () => {
    ...
    it('should handle summary errors', () => {
      ...
      expect(fileContent).toContain('res.status(500).json({')
      expect(fileContent).toContain('message: \'Failed to fetch attendance summary\'')
    })
  })

  describe('getDepartments Function', () => {
    it('should have getDepartments function with proper signature', () => {
    ...
    it('should handle departments errors', () => {
      ...
      expect(fileContent).toContain('res.status(500).json({')
      expect(fileContent).toContain('message: \'Failed to fetch departments\'')
    })
  })

  describe('getRecentAttendance Function', () => {
    it('should have getRecentAttendance function with proper signature', () => {
    ...
    it('should handle recent attendance errors', () => {
      ...
      expect(fileContent).toContain('res.status(500).json({')
      expect(fileContent).toContain('message: \'Failed to fetch recent attendance\'')
    })
  })

  describe('syncEmployees Function', () => {
    it('should have syncEmployees function with proper signature', () => {
    ...
    it('should handle sync errors', () => {
      ...
      expect(fileContent).toContain('res.status(500).json({')
      expect(fileContent).toContain('message: \'Failed to sync employees\'')
    })
  })
